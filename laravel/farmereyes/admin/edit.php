              ...
              <div class="content-box-large">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 personal-info">
                                  <div class="alert alert-info alert-dismissable" style="width:790px;">
                                    <a class="panel-close close" data-dismiss="alert">×</a> 
                                    <i class="fa fa-coffee"></i>
                                     <strong>Recheck Everything you input</strong>
                                  </div>
                                  <h3>Personal info</h3>
                                  ...
                                  <form class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="col-md-8">
                                        <input class="form-control" type="text" value="<?php echo $zone ?>">
                                      </div>
                                    </div>
                                     <div class="form-group">
                                      <label class="col-md-3 control-label">division:</label>
                                      <div class="col-md-8">
                                        <input class="form-control" type="text" value="<?php echo $division ?>">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-8">
                                        <input class="form-control" type="text" value="<?php echo $number ?>">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <label class="col-md-3 control-label">Password:</label>
                                      <div class="col-md-8">
                                        <input class="form-control" type="password" value="<?php echo $pass ?>">
                                      </div>
                                    </div>
                                    <!--
                                    <div class="form-group">
