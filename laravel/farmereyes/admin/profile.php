                          ...
                          <div class="panel panel-info">
                            <div class="panel-heading" style="height: 40px;">
                              <h3 class="panel-title"><?php echo $name ?></h3>
                               ...
                               <A href="logout.php" style="float:right; padding-left:5px;">Logout</A>
                               <A href="edit.php" style="float:right;">Edit Profile</A>
                            </div>
                            <div class="panel-body">
                              <div class="row">
                                ...
                                <div class=" col-md-9 col-lg-9 "> 
                                  ...
                                  <a href="#" class="btn btn-primary">Uploaded Data by Me</a>
                                  <a href="#" class="btn btn-primary">Total Uploaded Data by All user</a>
